...
| <a name="input_rsc_aws_exocompute_cluster_access"></a> [rsc\_aws\_exocompute\_cluster\_access](#input\_rsc\_aws\_exocompute\_cluster\_access) | EKS cluster access type for the Exocompute configuration. Possible values are EKS\_CLUSTER\_ACCESS\_TYPE\_PUBLIC and EKS\_CLUSTER\_ACCESS\_TYPE\_PRIVATE. | `string` | `null` | no |
